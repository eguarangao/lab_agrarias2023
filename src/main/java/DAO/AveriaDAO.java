...
public class AveriaDAO extends Conexion {
    ...
    public List<Averia> listarEquiposDañadosAveriasPorLaboratorio(int LaboID) throws SQLException {
        List<Averia> ListAveria = new ArrayList<>();
        this.conectar();
        String query = "select * from laboratorio.listaraveriasquiposdañadosporlaboratorio(?)";
